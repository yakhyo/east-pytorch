...
def train(train_img_path, train_gt_path, pths_path, batch_size, lr, num_workers, epoch_iter, interval):
    ...
    trainset = EASTDataset(train_img_path, train_gt_path)
...
if __name__ == '__main__':
    train_img_path = os.path.abspath('./data/ICDAR_2015/train_img')
    train_gt_path = os.path.abspath('./data/ICDAR_2015/train_gt')
    pths_path = './weights'
    batch_size = 24
    lr = 1e-3
    num_workers = 8
